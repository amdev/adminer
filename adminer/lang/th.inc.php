...
$translations = array(
	...
	'Network' => 'เครื่องข่าย',
	'Geometry' => 'เรขาคณิต',
	'File exists.' => 'ไฟล์นี้มีอยู่แล้ว.',
	'Attachments' => 'ไฟล์แนบ',
	'%d query(s) executed OK.' => '%d คำสั่งถูกดำเนินการแล้ว.',
	'Show only errors' => 'แสดงเฉพาะข้อผิดพลาด',
	'Refresh' => 'โหลดใหม่',
	...
	'HH:MM:SS' => 'HH:MM:SS',
	'Tables have been optimized.' => 'ปรับปรุงประสิทธิภาพของตารางแล้ว',
	'Vacuum' => 'Vacuum',
	'Selected' => 'เลือกแล้ว',
	'You have no privileges to update this table.' => 'คุณไม่ได้รับสิทธิ์ในการอัปเดทตารางนี้.',
	'Loading' => 'กำลังโหลด',
	'File must be in UTF-8 encoding.' => 'ไฟล์ต้องเข้ารหัสด้วย UTF-8.',
	'Modify' => 'แก้ไข',
	'Load more data' => 'โหลดข้อมูลอื่นๆ',
	'Full table scan' => 'สแกนตารางทั้งหมด',
	'Master password expired. <a href="http://www.adminer.org/en/extension/" target="_blank">Implement</a> %s method to make it permanent.' => 'รหัสผ่านหลักหมดอายุแล้ว. <a href="http://www.adminer.org/en/extension/" target="_blank">เครื่องมือ</a> %s ที่จะทำให้ใช้งานได้ถาวร.',
	'You can upload a big SQL file via FTP and import it from server.' => 'คุณสามารถอัปโหลดไฟล์ SQL ที่มีขนาดใหญ่ผ่านทาง FTP และนำเข้าผ่านทางเซอเวอร์.',
	'yes' => 'ใช่',
	'no' => 'ไม่',
);
